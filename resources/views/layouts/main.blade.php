	        ...
	        <div class="flex justify-start items-center">
	          ...
	          <a href="https://flowbite.com" class="flex items-center justify-between mr-4">
	            <img
	              ...
	              alt="Flowbite Logo"
	            />
	            <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">APN</span>
	          </a>
	          ...
	          <li>
	            ...
	            >
	              ...
	              <span class="flex-1 ml-3 text-left whitespace-nowrap"
	                > {{ auth()->user()->role_id === 1 ? 'Kelas' : 'User' }} </span
	              >
	              <svg
	                aria-hidden="true"
	                class="w-6 h-6"
	            ...
	            <ul id="dropdown-pages" class="hidden py-2 space-y-2">
	              <li>
	                <a
	                  href=" {{ auth()->user()->role_id === 1 ? route('kelas.index') : route('admin.addUser') }} "
	                  class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
	                  > {{ auth()->user()->role_id === 1 ? 'Kelas' : 'User' }} </a
	                >
	              </li>
	              <li>
	                <a
	                  href="#"
	                  class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
	                  > {{ auth()->user()->role_id === 1 ? 'Siswa' : 'Guru' }} </a
	                >
	              </li>
	              <li>
	                <a
	                  href="#"
	                  class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
	                  > {{ auth()->user()->role_id === 1 ? 'Absen' : 'Siswa' }} </a
	                >
	              </li>
	            </ul>
	          </li>
